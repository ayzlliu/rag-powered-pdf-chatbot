...
CORS(app, resources={
   r"/*": {
       ...
       # Header describe the package without being the actual content
...
# task type: takes text in and products text out
...
# to http://localhost:5000/upload-pdfs, Flask knows to run this function.
...
def upload_pdfs():
    ...
    try:
        ...
        # Embeds all chunks to vectors and get stored in ChromaDB
...
def ask_question():
    ...
    try: 
        ...
        prompt = PromptTemplate.from_template(
            "Read the context below and answer the question in a complete sentence.\n\nContext: {context}\n\nQuestion: {question}\n\nAnswer:"
        )
